...
contract DeployScript is Script {
    function run() external {
        ...
        EIP7702DelegateAccount delegateAccount = new EIP7702DelegateAccount(IEntryPoint(entryPointAddress));
        ...
        console2.log("EIP7702DelegateAccount:", address(delegateAccount));
        console2.log("USDTTokenPaymaster:", address(paymaster));
